...
const slides = [
  ...
  },
  {
    key: "hac",
    eyebrow: "Kutsal Topraklara Güvenle Yolculuk",
    title: "Kalbinizi Kâbe'ye,",
    accent: "Yolunuzu Bizimle Çevirin",
    text: "Kâbe-i Muazzama'nın manevi atmosferinde, kalpler huzur bulur, dualar umutla semaya yükselir. Rabbimize yakın olmanın huzurunu yaşayacağınız eşsiz bir yolculuğa adım atın.",
  ...
  },
  {
    ...
    title: "Selâm Sana",
    accent: "Ey Medine",
    text: "Asırlardır milyonlarca müminin özlemle ziyaret ettiği Medine-i Münevvere'de, Mescid-i Nebevî'nin manevi atmosferini hissedin. Bu kutlu şehirde gönlünüz huzur, diliniz dua ile buluşsun.",
    ctaLabel: "Umre Paketlerini İncele",
    ctaHref: "/umre",
    image: "/hero-medine.jpg",
    badge: "Mescid-i Nebevî",
  },
  {
    key: "kultur",
    eyebrow: "Yurt İçi Kültür Turları",
    title: "Türkiye'nin Eşsiz Güzelliklerini",
    accent: "Keşfedin",
    text: "Tarihi şehirler, doğal güzellikler ve kültürel mirasla buluşacağınız özenle planlanmış kültür turlarımızla her yolculuğu unutulmaz bir deneyime dönüştürüyoruz.",
    ctaLabel: "Yurt İçi Turları İncele",
    ctaHref: "/yurt-ici-turlar",
    image: "/hero-kultur.jpg",
    badge: "Kültür Turları",
  },
];
