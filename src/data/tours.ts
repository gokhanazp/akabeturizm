...
export const tours: Tour[] = [
  ...
  },
  {
    ...
    summary:
      "Ayder, Pokut ve Sümela'yı kapsayan, doğa ve kültürü buluşturan 4 gece konaklamalı Karadeniz turu.",
    description: [
    ...
    included: [
      "Ulaşım",
      "4 gece konaklama ve kahvaltı",
      "Rehberlik hizmeti",
      "Belirtilen geziler",
    ],
    excluded: ["Öğle yemekleri", "Kişisel harcamalar"],
    itinerary: [
      { day: "1. Gün", title: "Trabzon", detail: "Varış ve şehir turu." },
      { day: "2. Gün", title: "Sümela & Uzungöl", detail: "Manastır ve göl çevresi." },
      { day: "3-4. Gün", title: "Yaylalar", detail: "Ayder, Pokut ve doğa yürüyüşleri." },
      { day: "5. Gün", title: "Dönüş", detail: "Son geziler ve dönüş." },
    ],
    image: "karadeniz",
  },
];
